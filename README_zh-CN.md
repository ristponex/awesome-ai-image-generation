...
|:-----|:-------|:-----|:----------|:-----|:-----|:-----|:-----|:---------|
| **Nano Banana 2** | Google | 文生图 / 编辑 | 4K | ⚡⚡⚡ | ✅ | ❌ | ❌ | $0.072/次 |
| **Nano Banana 2 Dev** | Google | 文生图 / 编辑 | 4K | ⚡⚡⚡ | ✅ | ❌ | ❌ | $0.072/次 |
...
**Flux Schnell** 提供最低的单图成本，约 $0.003/张。高质量高性价比选 **Nano Banana 2**，$0.072/次。通过 [Atlas Cloud](https://www.atlascloud.ai?ref=JPM683) **首充赠送 25%**（最高 $100），更加实惠。
